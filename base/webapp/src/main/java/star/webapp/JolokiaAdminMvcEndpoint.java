 ...
 */
@ConfigurationProperties(prefix = "endpoints.jolokia-admin", ignoreUnknownFields = false)
public class JolokiaAdminMvcEndpoint implements MvcEndpoint, InitializingBean,
	...
	public JolokiaAdminMvcEndpoint() {
		this.path = "/jolokia-admin";
		this.controller.setServletClass(AgentServlet.class);
		this.controller.setServletName("jolokia-admin");
	}
