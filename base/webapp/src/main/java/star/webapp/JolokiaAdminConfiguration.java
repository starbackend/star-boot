...
@ConditionalOnProperty(prefix = "endpoints.jolokia-admin", name = "enabled", matchIfMissing = true)
@AutoConfigureBefore(ManagementSecurityAutoConfiguration.class)
@AutoConfigureAfter(EmbeddedServletContainerAutoConfiguration.class)
@EnableConfigurationProperties(JolokiaAdminProperties.class)
public class JolokiaAdminConfiguration {

	@Autowired
	JolokiaAdminProperties properties = new JolokiaAdminProperties();

	@Bean
	@ConditionalOnMissingBean
	public JolokiaAdminMvcEndpoint jolokiaAdminEndpoint() {
		JolokiaAdminMvcEndpoint endpoint = new JolokiaAdminMvcEndpoint();
